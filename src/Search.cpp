...
//
// // For the implementation we are assuming the memory requirnment is not to
// bad
//
// using namespace std;
...
//
//   while (blocks--) {
//     // Find the nearset block add the distance to the heuristic cost + 1 for
//     the
...
//   uint16_t agent_location = state.first;
//
//   // Create the open list a queue
//
//   // Just do breadth first search over the bit space
//   while (open.size()) {
//   }
//
